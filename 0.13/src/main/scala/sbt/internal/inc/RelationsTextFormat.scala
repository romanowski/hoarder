...
trait RelationsTextFormat extends FormatCommons {
  ...
  private val allRelations: List[Descriptor[_]] = {
    List(
      ...
      Descriptor("direct source dependencies", _.direct.internal, mappers.sourceMapper, mappers.sourceMapper), //TODO check
      Descriptor("direct external dependencies", _.direct.internal, mappers.sourceMapper, mappers.sourceMapper), //TODO check
      Descriptor("public inherited source dependencies", _.publicInherited.internal, mappers.sourceMapper, mappers.sourceMapper),
      Descriptor("public inherited external dependencies", _.publicInherited.external, mappers.sourceMapper, Mapper.forString),
